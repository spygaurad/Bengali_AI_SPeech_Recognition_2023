...
model = WhisperForConditionalGeneration.from_pretrained(model_id_only, cache_dir = "/home/wiseyak/suraj/huggingface_Dataset/cache" )
...
model.save_pretrained("/home/wiseyak/suraj/Bengali_ASR/huggingface_models/competition_data_whisper_models/v2_lora_ai4bharat_competition")
tokenizer.save_pretrained("/home/wiseyak/suraj/Bengali_ASR/huggingface_models/competition_data_whisper_models/v2_lora_ai4bharat_competition")

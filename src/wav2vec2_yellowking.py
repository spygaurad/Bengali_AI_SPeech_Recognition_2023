...
df = df.loc[df['sentence'].str.len() < 200]
...
processor = Wav2Vec2Processor.from_pretrained("/home/wiseyak/suraj/Bengali_ASR/Yellowking_models/YellowKing_processor")
model = Wav2Vec2ForCTC.from_pretrained("/home/wiseyak/suraj/Bengali_ASR/Yellowking_models/YellowKing_model")
...
training_args = TrainingArguments(
  report_to="wandb",
#   hub_token =  "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", #YOUR TOKEN HERE AS A STRING
  output_dir="/home/wiseyak/suraj/Bengali_ASR/huggingface_models/wav2vec2_models",
...
model.save_pretrained("/home/wiseyak/suraj/Bengali_ASR/huggingface_models/wav2vec2_models/wav2vec2_competition")
tokenizer.save_pretrained("/home/wiseyak/suraj/Bengali_ASR/huggingface_models/wav2vec2_models/wav2vec2_competition")
